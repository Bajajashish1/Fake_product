...
def restore_all_labels():
    """Restore all trashed label files that correspond to existing images"""
    labels_dir = r"d:\newww\dataset\labels\train"
    images_dir = r"d:\newww\dataset\images\train"
    ...
    for image_name in image_names:
        ...
        if image_name in label_groups:
            ...
            print(f"No label found for image: {image_name}.jpg")
    ...
    print(f"Total label files now: {final_label_count}")
